...
<!-- SideNavBar Shell -->
<nav class="w-[260px] h-screen fixed left-0 top-0 flex flex-col py-lg bg-surface border-r border-outline-variant z-50"><div class="px-lg mb-xl flex items-center gap-3">
