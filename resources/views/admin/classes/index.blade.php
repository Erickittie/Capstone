...
<div class="space-y-6">
    ...
    @if($errors->any())
        <div class="flex items-start gap-3 bg-red-50 border border-red-200 text-red-800 rounded-xl px-4 py-3 text-sm">
            <span class="material-symbols-outlined text-red-600 text-[20px]">
                error
            </span>
            ...
            <table class="w-full text-left text-sm text-gray-600">
                <thead class="bg-gray-50/80 border-b border-gray-200/80 text-xs uppercase font-semibold text-gray-500 tracking-wider">
                    <tr>
                        ...
                        <th class="py-3.5 px-6">Offercode</th>
                            ...
                            <td class="py-4 px-6 text-right">
                                ...
                                <div class="inline-flex items-center gap-2">
                                    ...
                                    <form
                                        ...
                                        <button
                                            type="submit"
                                            class="px-2.5 py-1.5 rounded-lg text-xs font-medium text-red-600 hover:bg-red-50 transition">
                                            Delete
                                        </button>
...
>
    ...
    >
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500">
                        Configure course offer code, term, and assign instructor.
                    </p>
        ...
        <form
            ...
            <!-- Offer Code / Semester / Academic Year -->
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                ...
                <div>
                    ...
                    <label
                        for="modal_offer_code"
                        class="block text-xs font-semibold uppercase tracking-wider text-gray-600 mb-1.5">

                        Offer Code <span class="text-rose-500">*</span>
