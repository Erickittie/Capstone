        ...
        @if(isset($class))
            ...
            <a
                ...
                class="
                    ...
                    transition
                    duration-150
                    {{ request()->routeIs('student.class.detail')
                        ? 'bg-gray-100 text-gray-950 font-semibold shadow-xs'
                        : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900 font-medium'
                    }}
                "
            ...
            <a
                ...
                class="
                    ...
                    transition
                    duration-150
                    {{ request()->routeIs('student.contribution')
                        ? 'bg-gray-100 text-gray-950 font-semibold shadow-xs'
                        : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900 font-medium'
                    }}
                "
            ...
            <a
                ...
                class="
                    ...
                    transition
                    duration-150
                    {{ request()->routeIs('student.group.status')
                        ? 'bg-gray-100 text-gray-950 font-semibold shadow-xs'
                        : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900 font-medium'
                    }}
                "
            ...
            <a
                ...
                class="
                    ...
                    transition
                    duration-150
                    {{ request()->routeIs('student.task.manager')
                        ? 'bg-gray-100 text-gray-950 font-semibold shadow-xs'
                        : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900 font-medium'
                    }}
                "
            ...
            <a
                ...
                class="
                    ...
                    transition
                    duration-150
                    {{ request()->routeIs('student.file.repository')
                        ? 'bg-gray-100 text-gray-950 font-semibold shadow-xs'
                        : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900 font-medium'
                    }}
                "
            ...
            <a
                ...
                class="
                    ...
                    transition
                    duration-150
                    {{ request()->routeIs('student.checkin.*')
                        ? 'bg-gray-100 text-gray-950 font-semibold shadow-xs'
                        : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900 font-medium'
                    }}
                "
